...
<tr>
	...
	<th	class="vm-cart-item-weight" ><?php echo vmText::_ ('COM_VIRTUEMART_PRODUCT_WEIGHT') //Вес изделия ?></th>
	...
	<th	class="vm-cart-item-weight-order" ><?php echo vmText::_ ('COM_VIRTUEMART_PRODUCT_ORDER') //Общий вес позиции ?></th>
...
<tr style="vertical-align: top" class="sectiontableentry<?php echo $i; if(!empty($prow->class)) echo ' '.$prow->class ?>">
	...
	<td	class="vm-cart-item-weight" ><?php echo round($prow->product_weight, 3) . ' кг' ; //вывод веса ?></td>
	...
	<!-- ВЫВОД ВЕСА -->
	<td class="vm-cart-item-weight-order" style="text-align: right;"><?php  if (!empty($prow->product_weight)){ $order_weight = $prow->quantity*$prow->product_weight; echo $order_weight . ' кг'; $prow->order_weight = $order_weight; }//Вес позиции?> 
...
<tr class="sectiontableentry<?php echo $i ?>">
	<td colspan="5" style="text-align: right;"><?php echo vmText::_($rule['calc_name']) ?> </td>
	<?php if (VmConfig::get ('show_tax')) { ?>
	<td style="text-align: right;"></td>
	<?php } ?>
...
<tr class="sectiontableentry2">
	...
	<?php  $order_weight_total = 0; if (isset($prow->order_weight)): $order_weight_total += $prow->order_weight; echo $order_weight_total.' кг'; $this->order_weight_total = $order_weight_total; endif?>
	</td>
